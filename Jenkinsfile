node ('master') {
 ...
 stage('git')
 {
  ...
  git branch: 'development', credentialsId: '932a8b1a-c0e0-4115-b5bf-18f6222a96bb', url: 'https://github.com/barathKawin/maven-web-application.git'
 }
...
stage('build')
 ...
 sshagent(['330432ff-d727-4ffe-9db7-65782a3166e9']) {
    ...
    sh "scp -o StrictHostKeyChecking=no target/maven-web-application-develop-1.0.war root@65.2.33.177:/opt/apache-tomcat-9.0.45/webapps/"
    }
  }
